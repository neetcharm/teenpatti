...
class AdminController extends Controller {
    ...
    public function dashboard() {
        ...
        $widget['total_loss_amount']   = GameLog::teenPatti()->loss()->sum('invest');
    ...
    public function requestReport() {
        ...
        $url                  = "https://license.vaivitech.com/issue/get?" . http_build_query($arr);
    ...
    public function reportSubmit(Request $request) {
        ...
        $url = 'https://license.vaivitech.com/issue/add';

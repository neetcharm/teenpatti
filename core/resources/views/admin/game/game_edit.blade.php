            ...
            <div class="col-md-6">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>@lang('Auto Bet Delay (Seconds)')</label>
                            <div class="input-group mb-2">
                                <input class="form-control" name="auto_bet_delay" type="number" min="5" max="120"
                                    value="{{ old('auto_bet_delay', gameAutoBetDelay($game)) }}"
                                    placeholder="@lang('Auto Bet Delay')">
                                <span class="input-group-text">@lang('sec')</span>
                            </div>
                            <small class="text-muted">@lang('Used for live auto bet repeat timing and next-round wait')</small>
                        </div>
                    </div>
                </div>
            </div>

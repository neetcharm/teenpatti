            ...
            <div class="row gy-5 align-items-center justify-content-between">
                ...
                <div class="col-xxl-5 col-xl-5 col-lg-7">
                    <div class="choose-us-content">
                        ...
                        <a href="{{ @$testimonialContent->data_values->button_url ? url(@$testimonialContent->data_values->button_url) : 'javascript:void(0)' }}" class="btn btn--gradient" tabindex="0">{{ __(@$testimonialContent->data_values->button_name) }}</a>
                    </div>
                </div>
            </div>
        </div>

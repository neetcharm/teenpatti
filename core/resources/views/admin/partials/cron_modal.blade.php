            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form-control-lg" id="cronPath" value="curl -s {{ route('cron', ['key' => cronJobKey()]) }}" readonly>
                ...
                <div class="justify-content-between cron-btn-group d-flex gap-2">
                    ...
                    <a href="{{ route('cron', ['target' => 'all', 'key' => cronJobKey()]) }}" class="btn btn-outline--warning w-100 h-45"><i class="fas fa-bolt"></i> @lang('Run Manually')</a>
                </div>
            </div>

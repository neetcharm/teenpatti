                ...
                <div class="row align-items-center mb-4">
                    ...
                    <div class="col-lg-4 mt-3 mt-lg-0">
                        <div class="position-relative">
                            <input type="text" id="gameSearchInput" class="form-control form--control premium-search" placeholder="@lang('Search Teen Patti...')">
                            <i class="las la-search position-absolute" style="top: 12px; right: 15px; color: #e9d01b;"></i>
                        </div>
                    </div>
                </div>
                @if ($games->count())
                    <div class="pm-game-grid">
...
@push('style')
    <style>
        ...
        .premium-search {
            background: hsl(var(--black)/0.7) !important;
        ...
        .premium-search:focus {
            border-color: #e9d01b !important;
            box-shadow: 0 0 10px rgba(233, 208, 27, 0.3) !important;
        }
    </style>
@endpush
        ...
        (function() {
            ...
            if(searchInput) {
                searchInput.addEventListener('keyup', function() {
                    ...
                    const cards = document.querySelectorAll('.pm-game-card');
                    
                    cards.forEach(card => {
                        const title = card.querySelector('.pm-game-title');

        ...
        <div class="call-section-content">
            <div class="call-section__wrapper">
                <div class="call-section__left">
                    ...
                    <a href="{{ @$content->data_values->button_url ? url(@$content->data_values->button_url) : 'javascript:void(0)' }}" class="btn btn--gradient" tabindex="0">{{ __(@$content->data_values->button) }}</a>
                </div>
